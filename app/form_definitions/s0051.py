...
S0051_FIELDS = [
    ...
    FormField(
        ...
        section=0,
        description="Name, Vorname der Person, aus deren Versicherung die Leistung beantragt wird (NICHT IM PDF, wird von PAT_NAME kopiert)",
        extract_from_ai=False,
    ),
    FormField(
    ...
    FormField(
        ...
        field_type=FieldType.TEXT,
        label_de="Straße, Hausnummer (Patient/in)",
        section=0,
    ...
    FormField(
        field_name="VERS_DIAGNOSE_5",
        field_type=FieldType.TEXT,
        label_de="Diagnose 5",
        section=2,
        description="Fünfte Diagnose (Diagnosetext)",
    ),
    FormField(
        field_name="VERS_DIAGNOSESCH_5",
        field_type=FieldType.TEXT,
        label_de="ICD-10 Code 5",
        section=2,
        description="ICD-10 Diagnoseschluessel zur fünften Diagnose",
    ),
    FormField(
        field_name="VERS_DIAGNOSE_6",
        field_type=FieldType.TEXT,
        label_de="Diagnose 6",
        section=2,
        description="Sechste Diagnose (Diagnosetext)",
    ),
    FormField(
        field_name="VERS_DIAGNOSESCH_6",
        field_type=FieldType.TEXT,
        label_de="ICD-10 Code 6",
        section=2,
        description="ICD-10 Diagnoseschluessel zur sechsten Diagnose",
    ),
    FormField(
        field_name="VERS_DIAGNOSE_7",
        field_type=FieldType.TEXT,
        label_de="Diagnose 7",
        section=2,
        description="Siebte Diagnose (Diagnosetext)",
    ),
    FormField(
        field_name="VERS_DIAGNOSESCH_7",
        field_type=FieldType.TEXT,
        label_de="ICD-10 Code 7",
        section=2,
        description="ICD-10 Diagnoseschluessel zur siebten Diagnose",
    ),
    FormField(
        field_name="VERS_DIAGNOSE_8",
        field_type=FieldType.TEXT,
        label_de="Diagnose 8",
        section=2,
        description="Achte Diagnose (Diagnosetext)",
    ),
    FormField(
        field_name="VERS_DIAGNOSESCH_8",
        field_type=FieldType.TEXT,
        label_de="ICD-10 Code 8",
        section=2,
        description="ICD-10 Diagnoseschluessel zur achten Diagnose",
    ),
    FormField(
        field_name="VERS_DIAGNOSE_9",
        field_type=FieldType.TEXT,
        label_de="Diagnose 9",
        section=2,
        description="Neunte Diagnose (Diagnosetext)",
    ),
    FormField(
        field_name="VERS_DIAGNOSESCH_9",
        field_type=FieldType.TEXT,
        label_de="ICD-10 Code 9",
        section=2,
        description="ICD-10 Diagnoseschluessel zur neunten Diagnose",
    ),
    FormField(
        field_name="VERS_DIAGNOSE_10",
        field_type=FieldType.TEXT,
        label_de="Diagnose 10",
        section=2,
        description="Zehnte Diagnose (Diagnosetext)",
    ),
    FormField(
        field_name="VERS_DIAGNOSESCH_10",
        field_type=FieldType.TEXT,
        label_de="ICD-10 Code 10",
        section=2,
        description="ICD-10 Diagnoseschluessel zur zehnten Diagnose",
    ),
